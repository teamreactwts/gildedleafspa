      ...
      <defs>
        <clipPath id="clip0_124_704">
          <rect
            ...
            height="8.1"
            fill={IconColor || "white"}
            transform="translate(0.449951 0.450012)"
          />
        </clipPath>
      </defs>
    </svg>
